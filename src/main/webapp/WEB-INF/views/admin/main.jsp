            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="bg-white p-8 rounded-[2.5rem] shadow-sm border border-slate-100 flex items-center justify-between transition-all hover:border-red-200 group">
                    <div class="flex items-center gap-6">
                        ...
                        <div>
                            <h4 class="text-2xl font-black text-slate-800">회원 신고 접수 건수</h4>
                            <p class="text-slate-500 mt-1 font-medium text-sm">부적절한 활동으로 유저가 신고 접수된 누적 건수입니다.</p>
                        </div>
                    </div>
                ...
                <div class="bg-white p-8 rounded-[2.5rem] shadow-sm border border-slate-100 flex items-center justify-between transition-all hover:border-purple-200 group">
                    <div class="flex items-center gap-6">
                        <div class="w-16 h-16 bg-purple-50 text-purple-500 rounded-full flex items-center justify-center text-2xl group-hover:scale-110 transition-transform">✈️</div>
                        <div>
                            <h4 class="text-2xl font-black text-slate-800">동행 게시글 신고 접수 건수</h4>
                            <p class="text-slate-500 mt-1 font-medium text-sm">동행 구하기 게시판에서 신고 접수된 누적 건수입니다.</p>
                        </div>
                    </div>
                    <div class="text-right">
                        <div class="text-sm font-bold text-slate-400 mb-1 tracking-tighter uppercase">Total Travel Reports</div>
                        <div class="text-5xl font-black text-purple-500">
                            <c:out value="${not empty stats.reportTravelTotal ? stats.reportTravelTotal : 0}" />
                            <span class="text-xl ml-1 font-bold">건</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-8 rounded-[2.5rem] shadow-sm border border-slate-100 flex items-center justify-between transition-all hover:border-orange-200 group">
                    <div class="flex items-center gap-6">
                        ...
                        <div>
                            <h4 class="text-2xl font-black text-slate-800">일반 게시글 신고 접수 건수</h4>
                            <p class="text-slate-500 mt-1 font-medium text-sm">운영 정책 위반으로 일반 게시물이 신고 접수된 누적 건수입니다.</p>
                        </div>
                    </div>
                    <div class="text-right">
